...
![截圖 2025-07-04 下午6.51.37.png](/images/website deployment/1.png)

但如果只有這樣，明顯不夠．因為這麼多個專案在 Vercel 上運行，這個 IP 對應了這麽多網域，怎麼知道是哪個．

Vercel 是透過**反向代理**的方式，讓同一個 IP 可以服務這麼多網域，所以我們還需要在 Vercel 這邊綁定域名．

![截圖 2025-07-04 下午6.51.47.png](/images/website deployment/2.png)
...
使用 [next-sitemap](/images/website deployment//www.npmjs.com/package/next-sitemap) 套件：
...
![Screenshot 2025-08-24 at 1.30.41 AM.png](/images/website deployment/Screenshot_2025-08-24_at_1.30.41_AM.png)
