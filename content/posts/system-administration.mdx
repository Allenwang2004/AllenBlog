---
title: System Administration Essentials for ML Engineers
description: A practical field guide to the Linux system administration concepts and tools I actually use day to day — package mirrors, SFTP, symbolic links for model checkpoints, the filesystem layout, and commands for managing shared CPU/GPU resources.
descriptionEn: A practical field guide to the Linux system administration concepts and tools I actually use day to day — package mirrors, SFTP, symbolic links for model checkpoints, the filesystem layout, and commands for managing shared CPU/GPU resources.
